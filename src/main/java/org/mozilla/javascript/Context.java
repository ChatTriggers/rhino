...
public class Context {
    ...
    /**
     * If set, then all intermediate output generated by Rhino will be output
     * to the directory specified by debugOutputPath. The following will be
     * output to the debugOutputPath if this flag is enabled: IR, nodes,
     * tokens, decompiled js, and java class files. If a context has this
     * feature enabled, but has not set a debugOutputPath by the time files
     * are compiled, an IllegalStateException will be thrown.
     *
     * @see Context#debugOutputPath
     * @see Context#setDebugOutputPath(File)
     * @see Context#getDebugOutputPath()
     */
    ...
    public final void setDebugOutputPath(File debugOutputPath) {
        setDebugOutputPath(debugOutputPath, true);
    }

    public final void setDebugOutputPath(File debugOutputPath, boolean clearFiles) {
        if (debugOutputPath.exists() && debugOutputPath.isDirectory() && clearFiles) {
            File[] files = debugOutputPath.listFiles();
    ...
    public final File getDebugOutputPath() {
        if (hasFeature(EMIT_DEBUG_OUTPUT)) {
     ...
     * @return the new array object.
     */
    public NativeArray newArray(Scriptable scope, Object[] elements) {
    ...
    private File debugOutputPath = null;
